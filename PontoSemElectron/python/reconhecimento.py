...
def reconhecimentoFacial(modo="ponto"): 
    if modo == "cadastro":
        print('Iniciando no modo cadastro...')
        # Não realizar reconhecimento facial
        return {"status": "sucesso", "mensagem": "Treinamento concluído sem reconhecimento."}
    else:

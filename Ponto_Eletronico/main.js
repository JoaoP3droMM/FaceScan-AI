...
const pythonCommand = 'python3'; // ! No windws trocar por python
...
function startCaptureAndTraining(matricula) {
    ...
    const capturaScriptPath = path.join('../python/captura.py')
    execPythonScript(capturaScriptPath, [matricula],
        ...
        () => {
            ...
            const treinamentoScriptPath = path.join('../python/treinamento.py')
...
function startRecognition() {
    ...
    const reconhecimentoScriptPath = path.join('../python/reconhecimento.py')
